...
public class Constants {
    ...
    public static final String WEBUI_BROWSER_TYPE = "webui.browser.type";
    public static final String WEBUI_DEFAULT_TIMEOUT = "webui.default.timeOut";
    public static final String WEBUI_SCREENSHOT_DIRECTORY = "webui.screenshot.directory";
    public static final String WEBUI_SCREENSHOT_FILE_TYPE = "webui.screenshot.fileType";
    public static final String WEBUI_TARGET = "webui.target";
    public static final String WEBUI_ENABLE_TRACING = "webui.enableTracing";
    public static final String WEBUI_HEADLESS = "webui.headless";
    public static final String PLAYWRIGHT_BROWSER_TYPE = "playwright.browser.type";
    public static final String PLAYWRIGHT_HEADLESS = "playwright.headless";
    public static final String PLAYWRIGHT_DEFAULT_TIMEOUT = "playwright.default.timeOut";
    public static final String PLAYWRIGHT_SCREENSHOT_DIRECTORY = "playwright.screenshot.directory";
    public static final String PLAYWRIGHT_SCREENSHOT_FILE_TYPE = "playwright.screenshot.fileType";
